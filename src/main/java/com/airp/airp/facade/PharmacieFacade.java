...
public class PharmacieFacade {
    ...
    public void enregistrer(PharmacieDto pharmacieDto) {
        Pharmacie pharmacieEexistante = pharmacieRepository.rechercherParNumero(pharmacieDto.getNumero())
                .orElseThrow(null);
        if (pharmacieEexistante != null){
            throw pharmacieExistanteException(pharmacieDto.getNumero());
        } else {
